...
const translations = {
  en: {
    ...
    "hero.desc": "Artfully blending user-experience research with senior-focused spatial aesthetics to orchestrate daily luxury and total peace of mind for Taipei's elite elders.",
    ...
    "retainer.silver.subtitle": "雅致日常管理",
    "retainer.silver.desc": "Designed for active seniors who appreciate fine logistics coordination, monthly luxury safety inspections, and a consistent partner for elite Taipei events.",
    "retainer.silver.feature1": "Weekly elegant companion excursions (3 hours/week)",
    "retainer.silver.feature2": "Primary home interior physical safety audit & simple optimization",
    "retainer.silver.feature3": "Bi-weekly curated medical/health coordination & transport mapping",
    "retainer.silver.cta": "Select Silver Lily",

    "retainer.gold.badge": "SIGNATURE ULTRA",
    "retainer.gold.title": "Gold Hearth",
    "retainer.gold.subtitle": "金萱至尊管家與美學",
    "retainer.gold.desc": "The ultimate comprehensive care model, pairing high-touch daily lifestyle management with deep aesthetic and structural interior upgrades for senior longevity.",
    "retainer.gold.feature1": "Full digital legacy setup & smartphone/tablet UI optimization",
    "retainer.gold.feature2": "Daily curated lifestyle concierge services with priority booking",
    "retainer.gold.feature3": "24/7 dedicated liaison and weekly UX reports shared with children globally",
    ...
    "form.option.silver": "Silver Lily Retainer (每月雅緻生活策展)",
    "form.option.gold": "Gold Hearth Retainer (頂級金萱全面託付)",
    "form.option.notSure": "Not sure yet (目前尚未決定，需初步評估)",
  ...
  zh: {
    ...
    "hero.title1": "優雅老去，",
    "hero.title2": "日常如詩。",
    "hero.desc": "巧妙融合「使用者體驗（UX）研究」與「高齡空間美學」，為台北頂峰長者量身定制奢華日常運營，給予子女最極致 of 安心託付。",
    "hero.cta1": "預約專屬諮詢",
    "hero.cta2": "評估父母的生活現況",
    ...
    "retainer.silver.subtitle": "Silver Lily",
    "retainer.silver.desc": "專為生活尚能自理，但追求極致生活細節、月度精緻安全檢測、並需要高品質台北藝文活動伴行的優雅長輩所設計。",
    "retainer.silver.feature1": "每週 3 小時尊榮藝文與生活伴行服務",
    "retainer.silver.feature2": "長輩主居住空間之年度美感與安全風險評估及微改動",
    "retainer.silver.feature3": "每兩週一次門診預約跟診、頂級專車接送與健康日誌追蹤",
    "retainer.silver.cta": "選擇銀萱方案",

    "retainer.gold.badge": "極奢生活全託付",
    "retainer.gold.title": "金萱臻藏方案",
    "retainer.gold.subtitle": "Gold Hearth",
    "retainer.gold.desc": "最極致的全面管家服務。將極高頻的日常頂級管家、社交密友行程，與大師級空間改造完美融合，為長輩打造能傳承的優雅晚年生活。",
    "retainer.gold.feature1": "全方位數位遺產整理與手機/平板高齡介面最佳化",
    "retainer.gold.feature2": "每日專屬生活管家高頻對接，頂級醫療、社交行程優先排定",
    "retainer.gold.feature3": "24/7 緊急對接與每週專屬 UX 生活報告（同步發送給全球子女）",
    ...
    "form.option.silver": "銀萱雅緻方案 (Silver Lily Retainer)",
    "form.option.gold": "金萱臻藏方案 (Gold Hearth Retainer)",
    "form.option.notSure": "目前尚未決定 (需要 Felicia 初步評估)",
