...
const translations = {
  en: {
    ...
    "nav.retainers": "Memberships",
    "nav.report": "Report Card",
    "nav.contact": "Inquire",
    
    "hero.subtitle": "TAIPEI'S PREMIER PRIVATE FAMILY OFFICE FOR AGING",
    "hero.title1": "When you can't be there,",
    "hero.title2": "We can.",
    "hero.desc": "Hearthlily blends high-touch companion curation with senior UI/UX safety coaching to protect your parent's daily life and digital security in Taipei. Elite non-clinical concierge care preserving senior dignity.",
    "hero.cta1": "Schedule Consultation",
    "hero.cta2": "Evaluate Parent's Setup",
    "hero.badge.title": "Private Family Office",
    "hero.badge.desc": "Fusing elegant lifestyle planning with bespoke day-to-day concierge services.",
    ...
    "story.role": "FOUNDER & CREATIVE DIRECTOR",

    "services.meta": "BESPOKE SYSTEM",
    "services.title": "The Pillars of Curation",
    "services.s1.title": "Digital Security & Safety",
    ...
    "retainer.meta": "PRIVATE MEMBERSHIPS",
    "retainer.title": "Private Membership Tiers",
    "retainer.silver.badge": "ESSENTIAL",
    "retainer.silver.title": "Essential Membership",
    "retainer.silver.subtitle": "Premium Lifestyle Escort · NT$30,000 / mo",
    ...
    "retainer.silver.feature1": "4 curated visits per month with bi-weekly updates",
    ...
    "retainer.silver.cta": "Select Essential",

    "retainer.gold.badge": "SIGNATURE (CORE)",
    "retainer.gold.title": "Signature Membership",
    "retainer.gold.subtitle": "Dedicated Life Curation & Liaison · NT$55,000 / mo",
    ...
    "retainer.gold.feature2": "Weekly curated active companion visits & medical accompaniment",
    "retainer.gold.feature3": "Weekly UX Family Reports & real-time updates via the Hearthlily Family Hub",
    "retainer.gold.cta": "Inquire Signature",
    ...
    "retainer.legacy.cta": "Select Legacy",
    ...
    "form.retainerType": "Interested Membership Level",
    "form.option.placeholder": "Select your preferred package...",
    "form.option.silver": "Essential Membership (NT$30,000 / month)",
    "form.option.gold": "Signature Membership (NT$55,000 / month)",
    "form.option.notSure": "Not sure yet (Requires initial NT$30,000 Private Family Assessment)",
  ...
  zh: {
    "nav.story": "創辦人故事",
    "nav.services": "三大服務板塊",
    "nav.retainers": "專屬會員方案",
    "nav.report": "高齡體驗評估卡",
    "nav.contact": "預約諮詢",
    
    "hero.subtitle": "台北頂級高齡私人家辦與生活美學",
    "hero.title1": "當您無法隨侍在側，",
    "hero.title2": "我們為您分憂。",
    "hero.desc": "當您無法隨侍在側，我們為您分憂。晴萱將頂級生活管家伴行與高齡智慧裝置防詐防護完美結合，為在台長輩打造尊嚴日常，給予海外子女最極致的安心託付。",
    "hero.cta1": "預約專屬諮詢",
    "hero.cta2": "評估長輩生活現狀",
    "hero.badge.title": "私人家辦",
    ...
    "story.p2": "她創立晴萱（Hearthlily）源於一個深刻領悟：台北的優雅長者需要的絕不是醫療照護，而是能優雅融合生活機能與藝文環境、有尊嚴的智識社交，以及經過精心設計、能隨身體機能調適卻毫無「醫療感」的家居美學。",
    "story.role": "創辦人 暨 創意總監",
    ...
    "services.s3.desc": "透過專業UX使用者研究工具、親和圖與空間痛點工作坊，為身處海外的子女與在台長者架起溝通橋樑，化解在生活調整上的摩擦與擔憂。",
    "services.s3.item1": "家族跨代生活期望工作坊",
    "services.s3.item2": "為海外子女提供客觀定期的 UX 生活報告書",

    "retainer.meta": "專屬會員級別",
    "retainer.title": "專屬家辦會員方案",
    "retainer.silver.badge": "ESSENTIAL",
    "retainer.silver.title": "銀萱雅緻方案",
    "retainer.silver.subtitle": "銀萱雅緻方案 · 每月 NT$30,000",
    "retainer.silver.desc": "專為生活尚能自理，但追求極致生活細節、月度數位安全防護、並需要高品質台北藝文活動伴行的優雅長輩所設計。",
    "retainer.silver.feature1": "每月 4 次專屬探視與雙週數位追蹤更新",
    "retainer.silver.feature2": "月度數位帳號安全審查與智慧裝置自適應優化",
    "retainer.silver.feature3": "個人化門診預約跟診、健康數據整理與頂級專車接送",
    "retainer.silver.cta": "選擇銀萱方案",

    "retainer.gold.badge": "SIGNATURE (核心)",
    "retainer.gold.title": "金萱專屬方案",
    "retainer.gold.subtitle": "金萱專屬方案 · 每月 NT$55,000",
    "retainer.gold.desc": "最頂級的全面管家服務。將高頻的日常頂級管家、社交密友行程，與大師級數位遺產整理完美融合，為長輩打造能傳承的優雅晚年生活。",
    "retainer.gold.feature1": "全方位數位遺產管理與手機/平板高齡介面最佳化",
    "retainer.gold.feature2": "每週專屬生活管家探視與醫療門診陪同跟診",
    "retainer.gold.feature3": "每週專屬 UX 報告與 Hearthlily Family Hub 線上即時照片動態更新",
    "retainer.gold.cta": "預約金萱方案",
    ...
    "form.option.silver": "Essential 方案 (每月 NT$30,000)",
    "form.option.gold": "Signature 方案 (每月 NT$55,000)",
    "form.option.notSure": "目前尚未決定 (需要支付 NT$30,000 首次到府家辦評估與數位安全稽核費)",
...
function updateDiagnosticOutput(safety = 5, social = 5, health = 5, delight = 5, average = 5) {
    ...
    const localizedInsights = {
      ...
      zh: {
        ...
        flourishingDesc: "非常優秀！長輩正享有尊嚴而充實的晚年。建議採用「銀萱雅緻方案」為長輩進行月度安全檢測與每週伴行，維持高水準的精緻日常細節。"
      }
    };
